// lib/screens/technician/technician_dashboard.dart
...
class _TechnicianDashboardState extends State<TechnicianDashboard>
  ...
  Future<void> _loadData() async {
    ...
    if (userId != null) {
      await Future.wait([
        quoteProvider.loadQuotesByUser(userId),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildRecentQuotesTable(context, recentQuotes, quoteProvider),
                const SizedBox(height: 24),
                _buildOfflineStatus(),
        ...
        children: [
          Container(
            ...
            child: CircleAvatar(
              ...
              child: Text(
                Helpers.getInitials(
                  authProvider.currentUser?.name ?? 'Technician',
                ),
                style: const TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.bold,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                const Icon(Icons.engineering, size: 14, color: Colors.white),
          ...
          children: [
            Expanded(
              child: _buildQuickAction(
                ...
                color: AppColors.primary,
                onTap: () {
                  Navigator.pushNamed(context, AppRoutes.createSiteQuote);
                },
              ),
            ),
            ...
            Expanded(
              child: _buildQuickAction(
                ...
                color: AppColors.secondary,
                onTap: () {
                  Navigator.pushNamed(context, AppRoutes.siteMeasurements);
                },
              ),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: _buildQuickAction(
                ...
                color: AppColors.info,
                onTap: () {
                  Navigator.pushNamed(context, AppRoutes.myQuotes);
                },
              ),
            ),
          ],
